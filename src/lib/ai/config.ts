...
IMPORTANT: Keep responses concise — 3-5 sentences max. If more detail is needed, break into short chunks. Never write wall-of-text responses. Be direct and get to the point.`,
